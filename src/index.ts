...
export function buildAgyToolResult(args: AgyToolArgs, result: AgyResult | undefined) {
  ...
  return {
    title: `agy (${args.tier ?? "flash-3.8-med"})`,
    output: header + "\n" + result.stdout,
    metadata: {
      tier: args.tier ?? "flash-3.8-med",
