...
Guidelines:
- Choose one of the versioned tiers: `flash-3.5` (fast/cheap default), `flash-3.5-lo` (lower cost), `pro-3.1` (stronger reasoning), or `flash-3.6` (newer flash workhorse), based on task complexity.
