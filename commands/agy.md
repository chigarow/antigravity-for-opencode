...
Guidelines:
- Choose one of the eleven versioned tiers: `flash-3.7-med` (default Medium), `flash-3.6-hi`, `flash-3.6-lo`, `flash-3.6-med`, `flash-3.7-hi`, `flash-3.7-lo`, `flash-3.5-hi`, `flash-3.5-med`, `flash-3.5-lo`, `pro-3.1-hi`, or `pro-3.1-lo`, based on task complexity. Removed unsuffixed High names (`flash-3.5`, `pro-3.1`, `flash-3.6`) and older bare names have no aliases.
